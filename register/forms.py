...
class SignUpForm(UserCreationForm):
    ...
    email = forms.EmailField(label="", max_length=70, required=True, widget=forms.TextInput(attrs={"placeholder":"Email"}))
    ads = forms.BooleanField(label="", initial=True)
    username = forms.CharField(label="", max_length=100, required=True, widget=forms.TextInput(attrs={"placeholder":"Username"}))
